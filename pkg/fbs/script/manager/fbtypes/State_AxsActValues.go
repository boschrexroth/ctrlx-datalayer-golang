...
func (t *State_AxsActValuesT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	State_AxsActValuesAddPos(builder, t.Pos)
	State_AxsActValuesAddDistLeft(builder, t.DistLeft)
	State_AxsActValuesAddVel(builder, t.Vel)
	State_AxsActValuesAddAcc(builder, t.Acc)
	State_AxsActValuesAddTorque(builder, t.Torque)
