...
func (t *AxsCmdFlexProfileDlParamsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	AxsCmdFlexProfileDlParamsAddSoiMasterOffsetDlIdx(builder, t.SoiMasterOffsetDlIdx)
	AxsCmdFlexProfileDlParamsAddSoiMasterOffsetVelDlIdx(builder, t.SoiMasterOffsetVelDlIdx)
	AxsCmdFlexProfileDlParamsAddSoiMasterOffsetAccDlIdx(builder, t.SoiMasterOffsetAccDlIdx)
	AxsCmdFlexProfileDlParamsAddSoiSlaveOffsetDlIdx(builder, t.SoiSlaveOffsetDlIdx)
	AxsCmdFlexProfileDlParamsAddSoiSlaveOffsetVelDlIdx(builder, t.SoiSlaveOffsetVelDlIdx)
	AxsCmdFlexProfileDlParamsAddSoiSlaveOffsetAccDlIdx(builder, t.SoiSlaveOffsetAccDlIdx)
	AxsCmdFlexProfileDlParamsAddFofMasterOffsetDlIdx(builder, t.FofMasterOffsetDlIdx)
	AxsCmdFlexProfileDlParamsAddFofMasterOffsetTimeConstantDlIdx(builder, t.FofMasterOffsetTimeConstantDlIdx)
...
func (rcv *AxsCmdFlexProfileDlParams) UnPackTo(t *AxsCmdFlexProfileDlParamsT) {
...
func (rcv *AxsCmdFlexProfileDlParams) Table() flatbuffers.Table {
	return rcv._tab
}
