...
func (t *profileConfigT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	profileConfigAddOutputBuffer(builder, outputBufferOffset)
	profileConfigAddProfileBasicData(builder, profileBasicDataOffset)
