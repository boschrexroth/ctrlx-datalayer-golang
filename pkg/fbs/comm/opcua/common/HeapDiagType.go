...
func (t *HeapDiagTypeT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	HeapDiagTypeAddTotalMemory(builder, t.TotalMemory)
...
func (rcv *HeapDiagType) TotalMemory() uint32 {
...
func (rcv *HeapDiagType) MutateTotalMemory(n uint32) bool {
...
func HeapDiagTypeAddTotalMemory(builder *flatbuffers.Builder, totalMemory uint32) {
	builder.PrependUint32Slot(2, totalMemory, 0)
}
